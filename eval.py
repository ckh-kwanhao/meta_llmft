...
def main():
    ...
    print("data_args.eval_task_name=", data_args.eval_task_name)
    print("Set your eval task(s) here!")
    arr_eval_task_name = ["paws-qqp", "cola-ood"]

    for eval_task_name in arr_eval_task_name:
        data_args.eval_task_name = eval_task_name
        print("Running eval task - data_args.eval_task_name=", data_args.eval_task_name)
        print("data_args.eval_task_path=", data_args.eval_task_path)
        ...
        if data_args.eval_task_name == "hans":
            ...
            data_args.eval_task_path = "/llmft/data/paws_qqp/dev_and_test.tsv"
            print("data_args.eval_task_path=", data_args.eval_task_path)
            ...
            data_args.eval_task_path = "/llmft/data/cola_ood/dev.tsv"
            print("data_args.eval_task_path=", data_args.eval_task_path)
        ...
        if data_args.max_seq_length > tokenizer.model_max_length:
            ...
            print("The max_seq_length passed is larger than the maximum length for the model. Using max_seq_length=", tokenizer.model_max_length)
            print("data_args.max_seq_length=", data_args.max_seq_length)
        ...
        logger.info(context)
        print("contex_indices=", contex_indices)
