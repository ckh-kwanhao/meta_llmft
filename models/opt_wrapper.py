...
class OPTDecoderLayer(transformers.models.opt.modeling_opt.OPTDecoderLayer):
    def __init__(self, config):
        ...
        ## Add adapters
        ## Edited by kwanhao_chan 2024-04-27
        print("Using adapters")
        print("Adapter type: ", config.adapter_type)
        # print("Adapter dim: ", config.adapter_dim)
        # print("Adapter dropout: ", config.adapter_dropout)
        # print("Adapter training: ", config.adapter_training)
        # print("Adapter lora_alpha: ", config.lora_alpha)
        print("Adapter use_adapters: ", config.use_adapters)
