...
def main():
    ...
    print("wandb_args", wandb_args)
    print("ft_args", ft_args)
    ...
    t_model_dir = "/llmft/model/teacher_model_1"
    t_model_dir_tk = "/llmft/model/teacher_model_1/tokens"
    train_t_model = False
    ...
    if train_t_model:
        ...
        if training_args.do_train:
            ...
            print("======Fine Tuning training metrics======")
            ...
            #trainer.model.save_model(t_model_dir)
            trainer.model.save_pretrained(t_model_dir)
    ...
    ### Comment out this block when doing Kd training on student model -- end -- ###
    ...
    if training_args.do_train:
        ...
        ### In case the configs loaded are inaccurate or causes errors, you can manually set the config here
        ...
        print("Loaded student model into KD trainer.")
    ...
    # Uncomment out this block when doing Kd training on student model -- start --
        ...
        ## Changed by kwanhao_chan 20240426 end





        print("======KD training metrics======")
